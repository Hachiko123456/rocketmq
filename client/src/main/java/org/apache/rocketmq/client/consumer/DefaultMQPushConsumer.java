...
public class DefaultMQPushConsumer extends ClientConfig implements MQPushConsumer {
     ...
     * 兵法消息消费时处理队列最大跨度，默认2000，表示如果消息处理队列中偏移量最大的消息与偏移量最小的消息跨度超过2000，则延迟50ms后再拉取消息
     */
     ...
     * queue waiting.
     * 最大消费重试次数，如果消息消费重试次数超过maxReconsumeTimes，则将该消息转移到一个失败队列，等待被删除
     */
